...
if (!isset($_SESSION['id_pracownika']) || $_SESSION['stanowisko'] !== 'HR') {
...
$sql_other_employees = "
    ...
    WHERE dr.stanowisko = 'pracownik, kierownik, prezes'";
...
<a href="../kadry/panel_kadrowy.php" class="panel_kadrowy">Panel Kadrowy</a>
<?php $conn->close();?>
<script src="../../js/scriptDOM.js"></script>
